...
| **Android**  | Android 8.1+ (API 27+) | SDL3 GPU utilise Vulkan introduit à partir d'Android 7.0 (API 24+), et surtout ONNX Runtime et le fournisseur d'exécution NNAPI demande au minimum Android 8.1+ (API 27.0+) |
