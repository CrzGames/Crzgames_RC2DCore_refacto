...
| **Linux**    | glibc >= 3.25    | Compatibilité avec les toolchains récents (on construit sur Ubuntu 22.04 donc glibc 2.35) et ONNX Runtime C++20 (glibc 2.31 pour C++ 20), donc avec glibc à 3.25 compatibles avec les distribution Linux : Ubuntu 22.04+, Debian 12+, Fedora 36+, Linux mint 21+, elementary OS 7+, CentOS 10+, RHEL 10+ |
