...
// Change la taille de la fenetre window pour correspondre a la taille du canvas
// En utilisant le template de RC2D, cela devrait etre appele a chaque fois que le canvas est redimensionne et la premiere fois lors de l'initialisation
...
*/
// Obtenez la taille de sortie en pixels d'un contexte de rendu.
